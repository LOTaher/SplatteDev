...
The name "Splatte" comes from the alias I have identified as online for almost a decade now. Funilly enough, it originated from a typo I made when changing my username from a game I used to play called "Growtopia". I honestly couldn't tell you what username I was actually thinking back then, but I didn't mind the accident, and have kept the name since. I'd like to say its unique, and I thought it would be fitting for my personal website.
